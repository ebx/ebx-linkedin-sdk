 ...
 *
 */
public class DefaultWebRequestor2 implements WebRequestor {
  
  private static final Logger logger = LoggerFactory.getLogger(DefaultWebRequestor2.class);
   ...
   */
  public DefaultWebRequestor2(String accessToken) {
   ...
   */
  public DefaultWebRequestor2(String accessToken, int connectTimeout, int readTimeout) {
    this.headers =
