 ...
 *
 */
public class LinkedInQueryParseException extends LinkedInAPIException {
  ...
  /**
   * Initialise the LinkedIn rate limit exception
   * @param errorMessage
   ...
   */
  public LinkedInQueryParseException(String errorMessage, Integer errorCode,
